      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            errorMsgElement.innerHTML = "navigator.getUserMedia error:".concat(_context.t0.toString());
...
document.querySelector('button#start').addEventListener('click', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
